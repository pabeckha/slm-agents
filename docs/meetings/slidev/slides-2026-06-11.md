...
The story: format compliance dominates so completely that running a method alone barely moves the needle. Few-shot (+3) and RAG (+1) are essentially noise. The one surprise is CoT at 26.25%: thinking step by step before answering accidentally produces more consistently formatted JSON, a self-scaffolding effect. But even that is 46 pp below CD alone.
...
|------|-------------|---------------|---------|
| 0.5B | 51.50% | 42.0% | 3.48% |
| 1.5B | 62.25% | 53.5% | 1.74% |
| 3B | 64.75% | 62.0% | 4.35% |
| 7B | 72.75% | 70.5% | 4.35% |
