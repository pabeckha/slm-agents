...
single-call gains do not transfer to harder agentic settings: accuracy falls to
4.3\% on $\tau$-bench retail and 0\% on BFCL \texttt{parallel}, showing that
multi-turn planning and multi-call emission require additional architectural
work.
