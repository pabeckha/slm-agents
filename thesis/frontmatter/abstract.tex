...
\texttt{simple\_python} under a strict whole-completion parser, which is
...
accepts the first complete JSON object and ignores trailing prose, and a
...
generic integration and strict parse contract rather than the model's
capability ceiling.
