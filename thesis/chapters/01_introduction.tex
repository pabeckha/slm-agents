...
\begin{enumerate}
    ...
    \item A comparison of optimized small language model configurations against frontier models on the Berkeley Function Calling Leaderboard (BFCL)~\cite{bfcl2024} and $\tau$-bench~\cite{yao2024taubench}.
