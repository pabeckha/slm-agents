...
extraction. The result is 65.5\% accuracy (262/400), a decrease of 6.5~pp
...
under Config~CD+Q, while breaking 50 cases that were correct. The net change is
$-26$ cases. Fig.~\ref{fig:cot-flip} shows the four-way breakdown.
...
synonyms (\texttt{algebra.quadratic\_roots} vs.\ \texttt{solve\_quadratic\-equation})
