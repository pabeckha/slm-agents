...
\caption{BFCL v4 simple\_python AST accuracy for all ten configurations.
         ...
         CD+FT-aligned (purple) is the only configuration to
         exceed the no-training ceiling established by CD.}
...
% PENDING: CD+Q+FT results (HPC jobs 28341348--28341349) -- section to be added once results are in.
