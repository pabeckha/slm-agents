...
% Semantic colours for delta cells in result tables (improves at-a-glance
% readability of ablation/size tables). Positive = green, negative = DTU red.
\newcommand{\dpos}[1]{\textcolor{green}{#1}}
\newcommand{\dneg}[1]{\textcolor{dtured}{#1}}
